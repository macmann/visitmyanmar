...
export const SPOTS:WorldSpot[]=[
 {id:'hotel',name:'Golden Tamarind Guesthouse',position:[-22,0,14],kind:'sleep',prompt:'Rest',color:'#d99058',description:'Your quiet base in the Tamarind Quarter.'},
 {id:'tea_shop',name:'Morning Star Tea Shop',position:[-7,0,9],kind:'food',prompt:'Order Food',color:'#57a773',description:'Steam, conversation, and local favourites.'},
 {id:'shwedagon',name:'Golden Pagoda Gardens',position:[19,0,-16],kind:'attraction',prompt:'Visit Landmark',color:'#e8b938',description:'A fictionalized landmark garden inspired by Yangon’s golden skyline.'},
 {id:'market',name:'Lanmadaw Market',position:[13,0,12],kind:'npc',prompt:'Talk',color:'#d75b61',description:'A compact neighbourhood market.'},
 ...
 {id:'bus',name:'Yangon Road Ticket Station',position:[-23,0,-16],kind:'travel',prompt:'Buy Ticket',color:'#5c75a8',description:'Express coaches depart for the next chapter.'}
];
